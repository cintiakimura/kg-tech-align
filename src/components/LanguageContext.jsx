...
const translations = {
  en: {
    ...
    company_info: "Organization Information",
    company_desc: "Please provide your organization details for invoicing purposes.",
    ...
    your_vehicles: "Your Fleet",
    add_vehicle: "Add New Vehicle",
    no_vehicles: "No fleet items added yet",
